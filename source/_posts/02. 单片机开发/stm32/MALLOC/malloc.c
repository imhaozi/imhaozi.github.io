...
//// 内存池(32字节对齐)
//__align(32) uint8_t mem1base[MEM1_MAX_SIZE];													// 内部SRAM1内存池
//__align(32) uint8_t mem2base[MEM2_MAX_SIZE] __attribute__((at(0X10000000)));					// 内部SRAM2内存池

//// 内存管理表
//uint32_t mem1mapbase[MEM1_ALLOC_TABLE_SIZE];													// 内部SRAM1内存池MAP
//uint32_t mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0X10000000 + MEM2_MAX_SIZE)));	// 内部SRAM2内存池MAP
...
// * @param   memx	所属内存块
// *
// * @return  uint16_t		使用率(扩大了10倍,0~1000,代表0.0%~100.0%)
// */
